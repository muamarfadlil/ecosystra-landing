...
function Navbar({ isDark, onToggle }: { isDark: boolean; onToggle: () => void }) {
  ...
  return (
    <nav style={{
      ...
      boxShadow: scrolled ? "0 2px 40px rgba(14,46,16,0.1), 0 1px 0 var(--border-subtle)" : "none",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <a href="#" style={{ display: "flex", alignItems: "center", gap: "0.75rem", textDecoration: "none" }}>
          <LogoIcon size={36} />
          <div>
            <div className="font-display" style={{ fontSize: "1.1rem", fontWeight: 700, color: "var(--text-heading)", lineHeight: 1.1, transition: "color 0.35s ease" }}>
              Eco System
            </div>
            <div style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.2em", color: "var(--gold)", textTransform: "uppercase", transition: "color 0.35s ease" }}>
              Nusantara
            </div>
          </div>
        </a>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.75rem" }} className="hidden-mobile">
          {navLinks.map((l) => (
            <a key={l.label} href={l.href} className="link-underline"
              style={{ textDecoration: "none", fontSize: "0.875rem", fontWeight: 500, color: "var(--text-heading)", transition: "color 0.25s" }}>
              {l.label}
            </a>
          ))}

          {/* Dark mode toggle */}
          <button onClick={onToggle} aria-label={isDark ? "Mode terang" : "Mode gelap"} className="dark-toggle">
            <span key={isDark ? "sun" : "moon"} className="animate-icon-in" style={{ display: "flex" }}>
        ...
        <div style={{ display: "none", alignItems: "center", gap: "0.6rem" }} className="mobile-controls">
          <button onClick={onToggle} aria-label={isDark ? "Mode terang" : "Mode gelap"} className="dark-toggle" style={{ width: 34, height: 34 }}>
            <span key={isDark ? "sun" : "moon"} className="animate-icon-in" style={{ display: "flex" }}>
              {isDark ? <SunIcon /> : <MoonIcon />}
            </span>
          </button>
          <button onClick={() => setOpen(!open)}
            style={{ background: "none", border: "none", cursor: "pointer", color: "var(--text-heading)", padding: "0.25rem", borderRadius: 6 }}
          ...
          {navLinks.map((l) => (
            <a key={l.label} href={l.href} onClick={() => setOpen(false)}
              style={{
                ...
                color: "var(--text-heading)", padding: "0.75rem 0",
                borderBottom: "1px solid var(--border-subtle)",
                transition: "color 0.2s, padding-left 0.25s",
              }}
              onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.color = "var(--forest-mid)"; (e.currentTarget as HTMLElement).style.paddingLeft = "8px"; }}
              onMouseLeave={(e) => { (e.currentTarget as HTMLElement).style.color = "var(--text-heading)"; (e.currentTarget as HTMLElement).style.paddingLeft = "0"; }}>
              {l.label}
            </a>
          ))}
...
function Hero() {
  return (
    <section id="home" style={{ minHeight: "100vh", position: "relative", overflow: "hidden", display: "flex", alignItems: "center" }}>
      {/* Themed gradient bg via CSS class */}
        ...
        <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          ...
          <div>
            ...
            <h1 className="font-display animate-fade-up opacity-0 delay-100"
              style={{ fontSize: "clamp(2.2rem,4.5vw,3.8rem)", fontWeight: 700, lineHeight: 1.13, color: "var(--text-heading)", marginBottom: "0.4rem", transition: "color 0.35s ease" }}>
              Sistem Keselamatan
            </h1>
            ...
            <p className="animate-fade-up opacity-0 delay-300"
              style={{ fontSize: "1.05rem", color: "var(--text-body)", fontStyle: "italic", marginBottom: "1rem", fontWeight: 300, lineHeight: 1.6, transition: "color 0.35s ease" }}>
            ...
            <p className="animate-fade-up opacity-0 delay-400"
              style={{ fontSize: "0.95rem", color: "var(--text-body)", lineHeight: 1.85, marginBottom: "2.5rem", maxWidth: 520, transition: "color 0.35s ease" }}>
            ...
            <div className="animate-fade-up opacity-0 delay-500" style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              <a href="#layanan" className="btn-primary">
                <span style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>Jelajahi Layanan <ArrowRight /></span>
              </a>
            ...
            <div className="animate-fade-up opacity-0 delay-600"
              style={{ display: "flex", gap: "2.5rem", marginTop: "3rem", flexWrap: "wrap", paddingTop: "2rem", borderTop: "1px solid var(--border-subtle)" }}>
              {stats.map((s) => (
                <div key={s.label} className="stat-item">
                  ...
                  <div style={{ fontSize: "0.73rem", color: "var(--text-muted)", marginTop: "0.3rem", fontWeight: 500, transition: "color 0.35s ease" }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="hero-visual animate-float-slow" style={{ position: "relative" }}>
            <div style={{
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                <div className="section-label" style={{ color: "var(--gold)", marginBottom: "1.5rem" }}>Ekosistem Terintegrasi</div>
                ...
                <div style={{ marginTop: "1.5rem", paddingTop: "1.5rem", borderTop: "1px solid rgba(255,255,255,0.07)", display: "flex", gap: "2rem" }}>
            ...
            <div style={{
              ...
              <span style={{ fontSize: "0.75rem", fontWeight: 600, color: "var(--text-heading)", whiteSpace: "nowrap", transition: "color 0.35s ease" }}>Konsultasi Gratis Tersedia</span>
            </div>
      ...
      <div style={{
        ...
        <span style={{ fontSize: "0.62rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--text-muted)" }}>Scroll</span>
...
function Services() {
  ...
  return (
    <section id="layanan" ref={ref} style={{ padding: "7rem 0", background: "var(--cream-dark)", position: "relative", overflow: "hidden", transition: "background-color 0.4s ease" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem" }}>
        <div style={{ textAlign: "center", marginBottom: "4.5rem" }} className={inView ? "animate-fade-up" : "opacity-0"}>
          <div className="section-label" style={{ marginBottom: "1rem" }}>Layanan Kami</div>
          <h2 className="font-display" style={{ fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 700, color: "var(--text-heading)", marginBottom: "1rem", transition: "color 0.35s ease" }}>
          ...
          <p style={{ color: "var(--text-muted)", maxWidth: 540, margin: "0 auto", lineHeight: 1.75, fontSize: "0.95rem", transition: "color 0.35s ease" }}>
          ...
          {services.map((svc, i) => (
            <div key={i} className={`card-premium ${inView ? "animate-fade-up" : "opacity-0"}`}
              ...
              <div style={{ padding: "2rem 2rem 2.2rem" }}>
                ...
                <h3 className="font-display" style={{ fontSize: "1.2rem", fontWeight: 700, color: "var(--text-heading)", marginBottom: "0.8rem", lineHeight: 1.3, transition: "color 0.35s ease" }}>
                  {svc.title}
                </h3>
                <p style={{ color: "var(--text-muted)", fontSize: "0.875rem", lineHeight: 1.75, marginBottom: "1.4rem", transition: "color 0.35s ease" }}>{svc.desc}</p>
                <div style={{ display: "flex", flexDirection: "column", gap: "0.55rem" }}>
                  {svc.items.map((item, j) => (
                    <div key={j} style={{ display: "flex", alignItems: "flex-start", gap: "0.65rem" }}>
                      ...
                      <span style={{ fontSize: "0.82rem", color: "var(--text-body)", lineHeight: 1.5, transition: "color 0.35s ease" }}>{item}</span>
                    </div>
                  ))}
                </div>
                <div style={{ marginTop: "1.8rem", paddingTop: "1.4rem", borderTop: `1px solid ${svc.accent}18` }}>
                  <a href="#kontak" style={{
                    ...
                    letterSpacing: "0.04em", transition: "gap 0.25s ease",
                  }}
...
function WhyUs() {
  const { ref, inView } = useInView();
  return (
    <section id="mengapa" ref={ref} style={{ padding: "7rem 0", background: "var(--bg-dark-section)", position: "relative", overflow: "hidden", transition: "background-color 0.4s ease" }}>
      <div style={{
        position: "absolute", left: "-12%", bottom: "-18%",
        width: "55vw", height: "55vw", borderRadius: "50%",
        border: "1px dashed rgba(201,168,76,0.14)", pointerEvents: "none",
      }} />
      <div style={{
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", position: "relative", zIndex: 2 }}>
        <div className="whyus-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <div className={inView ? "animate-slide-left" : "opacity-0"}>
            ...
            <a href="#kontak" className="btn-primary"><span>Mulai Perjalanan Bersama Kami</span></a>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
            {whyUs.map((item, i) => (
              <div key={i}
                ...
                style={{ animationDelay: `${0.08 * i}s`, borderRadius: 12, padding: "1rem 1.2rem", display: "flex", alignItems: "flex-start", gap: "1rem", borderLeft: "3px solid rgba(201,168,76,0.35)" }}>
      ...
      <style>{`@media (max-width: 768px) { .whyus-grid { grid-template-columns: 1fr !important; gap: 3rem !important; } }`}</style>
    </section>
  );
}
...
function About() {
  const { ref, inView } = useInView();
  return (
    <section id="tentang" ref={ref} style={{ padding: "7rem 0", background: "var(--cream)", transition: "background-color 0.4s ease" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem" }}>
        <div className="about-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          ...
          <div className={inView ? "animate-slide-left" : "opacity-0"} style={{ position: "relative" }}>
            <div style={{
              ...
              <div style={{
                ...
                border: "1px solid rgba(255,255,255,0.15)", borderRadius: 12, padding: "0.75rem 1rem",
              }}>
            ...
            <div style={{
              ...
              background: "var(--bg-card)", borderRadius: 14, padding: "1rem 1.2rem",
              boxShadow: "0 20px 40px rgba(14,46,16,0.15)", border: "1px solid var(--border-subtle)",
              ...
              <div>
                <div style={{ fontSize: "0.78rem", fontWeight: 700, color: "var(--text-heading)", transition: "color 0.35s ease" }}>QHSE Certified</div>
                <div style={{ fontSize: "0.65rem", color: "var(--text-muted)", transition: "color 0.35s ease" }}>ISO 45001 Ready</div>
              </div>
            </div>
          </div>
          ...
          <div className={inView ? "animate-slide-right" : "opacity-0"} style={{ animationDelay: "0.15s" }}>
            ...
            <h2 className="font-display" style={{ fontSize: "clamp(1.7rem,3vw,2.3rem)", fontWeight: 700, color: "var(--text-heading)", marginBottom: "1.2rem", lineHeight: 1.3, transition: "color 0.35s ease" }}>
            ...
            <p style={{ color: "var(--text-body)", lineHeight: 1.85, fontSize: "0.95rem", marginBottom: "1.2rem", transition: "color 0.35s ease" }}>
            ...
            <p style={{ color: "var(--text-body)", lineHeight: 1.85, fontSize: "0.95rem", marginBottom: "2.5rem", transition: "color 0.35s ease" }}>
            ...
            <div style={{ display: "flex", gap: "0", border: "1px solid var(--border-subtle)", borderRadius: 12, overflow: "hidden", transition: "border-color 0.35s ease" }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: "0.65rem", color: "var(--text-muted)", fontWeight: 500, marginTop: "0.2rem", transition: "color 0.35s ease" }}>{sub}</div>
                </div>
              ))}
            </div>
          </div>
...
function Clients() {
  ...
  return (
    <section id="klien" ref={ref} style={{ padding: "5.5rem 0", background: "var(--cream-dark)", overflow: "hidden", transition: "background-color 0.4s ease" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", marginBottom: "3rem" }}>
        <div style={{ textAlign: "center" }} className={inView ? "animate-fade-up" : "opacity-0"}>
          ...
          <h2 className="font-display" style={{ fontSize: "clamp(1.5rem,3vw,2.2rem)", fontWeight: 700, color: "var(--text-heading)", transition: "color 0.35s ease" }}>
            Klien &amp; Mitra Kami
          </h2>
        ...
        <div className="ticker-track" style={{ gap: "1rem", padding: "0.25rem 0.5rem" }}>
          {doubled.map((c, i) => (
            <div key={i} style={{
              ...
              border: c === "+ Banyak Lagi" ? "none" : "1px solid var(--border-subtle)",
              flexShrink: 0,
              ...
              <span className="font-display" style={{
                ...
                color: c === "+ Banyak Lagi" ? "rgba(255,255,255,0.85)" : "var(--text-heading)",
...
function Contact() {
  ...
  const infoItems = [
    { icon: <PhoneIcon />, label: "Telepon / WhatsApp", val: "+62 812-3456-7890", color: "var(--forest-mid)"  },
    { icon: <MailIcon />,  label: "Email",              val: "info@ecosystra.com", color: "var(--gold)"       },
    { icon: <MapPinIcon />, label: "Alamat",            val: "Jakarta & Bandung, Indonesia", color: "var(--forest-light)" },
  ];

  return (
    <section id="kontak" ref={ref} style={{ padding: "7rem 0", background: "var(--cream)", position: "relative", overflow: "hidden", transition: "background-color 0.4s ease" }}>
      <div style={{
        position: "absolute", right: "-8%", bottom: "-20%", width: "45vw", height: "45vw", borderRadius: "50%",
        background: "radial-gradient(circle, rgba(45,122,48,0.05) 0%, transparent 65%)", pointerEvents: "none",
      }} />
      <div style={{
        position: "absolute", left: "-5%", top: "10%", width: "25vw", height: "25vw", borderRadius: "50%",
        border: "1px dashed rgba(201,168,76,0.15)", pointerEvents: "none",
      }} />
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 2rem", position: "relative", zIndex: 2 }}>
        <div style={{ textAlign: "center", marginBottom: "4rem" }} className={inView ? "animate-fade-up" : "opacity-0"}>
          ...
          <div style={{ width: 60, height: 3, background: "linear-gradient(90deg,var(--gold),var(--forest-light))", borderRadius: 2, margin: "0 auto 1.2rem" }} />
          <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", maxWidth: 480, margin: "0 auto", lineHeight: 1.7, transition: "color 0.35s ease" }}>
        ...
        <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: "2.5rem", alignItems: "start" }}>
          ...
          <div className={inView ? "animate-slide-left" : "opacity-0"} style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
            {infoItems.map(({ icon, label, val, color }, i) => (
              <div key={i} className="contact-card" style={{ display: "flex", alignItems: "flex-start", gap: "1rem", padding: "1.25rem 1.3rem" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "0.9rem", color: "var(--text-heading)", fontWeight: 600, transition: "color 0.35s ease" }}>{val}</div>
                </div>
              </div>
            ))}
            ...
            <a href="https://wa.me/6281234567890?text=Halo%20Ecosystra%2C%20saya%20ingin%20konsultasi%20gratis"
              ...
              onMouseEnter={(e) => { const el = e.currentTarget as HTMLElement; el.style.transform = "translateY(-3px)"; el.style.boxShadow = "0 14px 32px rgba(37,211,102,0.4)"; }}
              onMouseLeave={(e) => { const el = e.currentTarget as HTMLElement; el.style.transform = "translateY(0)"; el.style.boxShadow = "0 8px 24px rgba(37,211,102,0.3)"; }}>
          ...
          <div className={inView ? "animate-slide-right" : "opacity-0"} style={{ animationDelay: "0.15s" }}>
            <div style={{
              background: "var(--bg-card)", borderRadius: 18, padding: "2.5rem",
              border: "1px solid var(--border-subtle)",
              ...
              {sent ? (
                <div style={{ textAlign: "center", padding: "3rem 0" }}>
                  ...
                  <h3 className="font-display" style={{ fontSize: "1.4rem", color: "var(--text-heading)", marginBottom: "0.5rem", transition: "color 0.35s ease" }}>Pesan Terkirim!</h3>
                  <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", lineHeight: 1.6, transition: "color 0.35s ease" }}>Tim kami akan menghubungi Anda dalam 1×24 jam.</p>
                </div>
              ) : (
                <div style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
                  <h3 className="font-display" style={{ fontSize: "1.3rem", fontWeight: 700, color: "var(--text-heading)", marginBottom: "0.5rem", transition: "color 0.35s ease" }}>
                    Kirim Pesan
                  </h3>
                  {[
                  ...
                  <select value={form.service} onChange={(e) => setForm({ ...form, service: e.target.value })}
                    className="input-field"
                    style={{ color: form.service ? "var(--text-heading)" : "var(--text-subtle)", appearance: "none", cursor: "pointer" }}>
...
function Footer() {
  return (
    <footer style={{ background: "var(--bg-dark-section)", color: "rgba(255,255,255,0.65)", padding: "4.5rem 0 2rem", position: "relative", overflow: "hidden", transition: "background-color 0.4s ease" }}>
      <div style={{
        position: "absolute", inset: 0,
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 2rem", position: "relative", zIndex: 1 }}>
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "0.85rem", lineHeight: 1.8, maxWidth: 300, color: "rgba(255,255,255,0.45)", marginBottom: "1.5rem" }}>
              Your end-to-end partner in safety, compliance, and operational digitalization.
            </p>
            {/* Social */}
            <div style={{ display: "flex", gap: "0.75rem" }}>
              {[
                ...
                { title: "Twitter/X",   d: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.74l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
              ].map(({ title, d }) => (
                <a key={title} href="#" title={title} style={{
                  width: 36, height: 36, borderRadius: 8,
                  background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.1)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  color: "rgba(255,255,255,0.5)", transition: "all 0.25s ease", textDecoration: "none",
                }}
                  onMouseEnter={(e) => { const el = e.currentTarget as HTMLElement; el.style.background = "rgba(201,168,76,0.2)"; el.style.borderColor = "rgba(201,168,76,0.4)"; el.style.color = "var(--gold-light)"; el.style.transform = "translateY(-3px)"; }}
                  onMouseLeave={(e) => { const el = e.currentTarget as HTMLElement; el.style.background = "rgba(255,255,255,0.07)"; el.style.borderColor = "rgba(255,255,255,0.1)"; el.style.color = "rgba(255,255,255,0.5)"; el.style.transform = "translateY(0)"; }}>
          ...
          <div>
            ...
            {navLinks.map((l) => (
              <div key={l.label} style={{ marginBottom: "0.55rem" }}>
                <a href={l.href} style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.875rem", transition: "all 0.25s ease", display: "inline-block" }}
          ...
          <div>
            ...
            {["QHSE Training", "Management Consulting", "Digital Platform", "Sertifikasi ISO"].map((s) => (
              <div key={s} style={{ marginBottom: "0.55rem" }}>
                <a href="#layanan" style={{ color: "rgba(255,255,255,0.5)", textDecoration: "none", fontSize: "0.875rem", transition: "all 0.25s ease", display: "inline-block" }}
                  onMouseEnter={(e) => { const el = e.currentTarget as HTMLElement; el.style.color = "var(--gold-light)"; el.style.paddingLeft = "6px"; }}
                  onMouseLeave={(e) => { const el = e.currentTarget as HTMLElement; el.style.color = "rgba(255,255,255,0.5)"; el.style.paddingLeft = "0"; }}>
                  {s}
                </a>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
          <span style={{ fontSize: "0.8rem", color: "rgba(255,255,255,0.35)" }}>© 2025 Ecosystem Nusantara. Hak cipta dilindungi.</span>
